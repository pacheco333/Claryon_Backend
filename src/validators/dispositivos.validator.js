...
export const createDispositivoValidator = [
...
export const updateDispositivoValidator = [
  validateIdParam,
...
export const idDispositivoValidator = [ validateIdParam, handleValidationResult ];